        ...
        for root, _, files in os.walk(data_dir):
            for file in files:
                if file.lower().endswith(".jpg"):
                    ...
                    label_filename = f"{os.path.splitext(file)[0]}.png"
...
def main(args):
    ...
    get_train_data(
        data_dir = "datasets/srti/train/",
        label_dir = "datasets/srti/train_labels/",
        output_path = args.output_dir + "train.jsonl",
        output_label_dir = args.output_dir + "label/",
    )
    
    get_train_data(
        data_dir = "datasets/srti/test/",
        label_dir = "datasets/srti/test_labels/",
        output_path = args.output_dir + "test.jsonl",
        output_label_dir = args.output_dir + "label/",
    )
        
    get_train_data(
        data_dir = "datasets/srti/val/",
        label_dir = "datasets/srti/val_labels/",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir",type=str,default = "datasets/srti/srti_train/")
