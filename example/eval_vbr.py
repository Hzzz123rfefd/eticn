...
# python  example/eval_vbr.py --model_config_path config/vaic/vaic_msd.yml --data_path datasets/camvid/camvid_train/val.jsonl --model_path saved_model/vaic/vaic_msd/ --save_path result/1.json